# # Compute daily transports along contour and save: for OM2 025
...
if __name__ == '__main__':
	...
	vhrho = vhrho.rename({'yt_ocean_sub02':'yt_ocean', 'xt_ocean_sub01':'xt_ocean'})
	uhrho = uhrho.rename({'yt_ocean_sub02':'yt_ocean', 'xt_ocean_sub01':'xt_ocean'})
	...
	print('vol_trans_across_contour calculated')
	###############################
	# ### Extract potrho0 along contour:
	potrho0 = cc.querying.getvar(expt,'pot_rho_0',session,ncfile='ocean_daily_3d_pot_rho_0.nc') - 1000
	...
	print('Importing previous sigma definitions')
	###############################
	# ### Bin into density:
	...
	print('Saving data...')
	### Save:
	save_dir = '/g/data/ik11/users/wf4500/DSW_collaborative/Daily_mass_transports/'+expt+'/Antarctic_cross_slope/'
