...
if __name__ == '__main__':
	...
	potrho0 = cc.querying.getvar(expt,'pot_rho_0',session,ncfile='%daily%') - 1000
	...
	### Save:
	save_dir = '/g/data/v45/wf4500/DSW_collaborative/Daily_mass_transports/'+expt+'/Antarctic_cross_slope/'
