...
### Updates on H2
**Control run**: We needed to rerun the RYF simulation with its original vertical grid (KDS75),as a control, and to analyze how long it takes until we have DSW formation in ACCESS-OM2-01. The only change made in comparisson to the old OM2-01 RYF run, is that the batrymetry was changed to match the future bathymetry used in 01deg_jra55v13_ryf9091_5m. The new bathymetry file can be found at
